...
export const ReservationsList = ({ selectedDate, setSelectedDate }: ReservationsListProps) => {
  ...
  const reservations: Reservation[] = [
    { id: 1, name: 'James Wilson', people: 4, time: '7:30 PM', date: format(selectedDate, 'yyyy-MM-dd'), status: 'confirmed', phone: '(555) 123-4567', tableNumber: 12 },
    { id: 2, name: 'Sarah Johnson', people: 2, time: '8:00 PM', date: format(selectedDate, 'yyyy-MM-dd'), status: 'confirmed', phone: '(555) 234-5678', tableNumber: 5 },
    { id: 3, name: 'Michael Chen', people: 6, time: '6:45 PM', date: format(selectedDate, 'yyyy-MM-dd'), status: 'pending', phone: '(555) 345-6789', notes: 'Celebration dinner' },
    { id: 4, name: 'Emily Martinez', people: 3, time: '7:00 PM', date: format(selectedDate, 'yyyy-MM-dd'), status: 'confirmed', phone: '(555) 456-7890', tableNumber: 8 },
    { id: 5, name: 'David Thompson', people: 5, time: '8:30 PM', date: format(selectedDate, 'yyyy-MM-dd'), status: 'pending', phone: '(555) 567-8901', notes: 'Near window' },
    { id: 6, name: 'Jessica White', people: 2, time: '6:30 PM', date: format(selectedDate, 'yyyy-MM-dd'), status: 'cancelled', phone: '(555) 678-9012' },
  ];
